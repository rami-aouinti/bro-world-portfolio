export const glowCardVariants = {
  ...
  rose: {
    accent: '#f472b6',
    background: 'linear-gradient(135deg, rgba(15, 23, 42, 0.94) 0%, rgba(244, 114, 182, 0.35) 100%)',
  ...
  slate: {
    accent: '#64748b',
    background: 'linear-gradient(135deg, rgba(15, 23, 42, 0.94) 0%, rgba(100, 116, 139, 0.32) 100%)',
